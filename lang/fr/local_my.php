...
$string['asadminpagetitle'] = 'J\'administre';
...
$string['byenddate'] = 'Par date de fin';
$string['bycompletion'] = 'Par achèvement';
$string['bylastaccess'] = 'Derniers consultés d\'abord';
$string['byfavorites'] = 'Par préférence';
...
$string['courseareasavailables'] = 'Zones de cours en autoinscription';
...
$string['displaylist'] = 'Liste';
$string['displaysummary'] = 'Résumés';
...
$string['errorbadblock'] = 'Instance de bloc {$a} non existante dans ce contexte';
$string['expandall'] = 'Tout ouvrir';
$string['everything'] = 'Tout';
$string['filterisediting'] = 'Est éditeur';
$string['cannotedit'] = 'Sans droits d\'édition';
...
$string['fullpath'] = 'Chemin complet';
...
$string['localmyenablerolecontrolincourseareas'] = 'Filtrer l\'aire de cours selon le role';
$string['localmyenablerolecontrolincourseareas_desc'] = 'Si activé, la liste de cours qui apparaît dans cette aire de cours sera filtrée selon le role courant lié au panneau courant.';
...
$string['localmyhidedescriptions'] = 'Cacher les descriptions';
$string['localmyhidedescriptions_desc'] = 'Cacher les descriptions de cours dans les boites de cours';
$string['localmyhideprogression'] = 'Cacher la progression';
$string['localmyhideprogression_desc'] = 'Cacher les indicateurs de progression';
$string['localmylayout'] = 'Agencement de Mon Moodle amélioré';
...
$string['localmymodules'] = 'Modules actifs pour les étudiants';
...
$string['localmyslick'] = 'Activer le slider';
$string['localmyslick_desc'] = 'Si non actif, les blocs seront affiches en grille sans effet de glissement.';
$string['localmyteachermodules'] = 'Modules actifs pour les enseignants';
$string['localmytrimlength1'] = 'Césure 1';
$string['localmytrimlength1_desc'] = 'La longueur admise (en unités de césure) pour les textes courts (titres)';
$string['localmytrimlength2'] = 'Césure 2';
$string['localmytrimlength2_desc'] = 'La longueur admise (en unités de césure) pour les textes longs (descriptifs, les balises html sont supprimées)';
...
$string['localprofilefieldforcelistmode'] = 'Champ de profil pour forcer le mode liste';
$string['localprofilefieldforcelistmode_desc'] = '';
$string['localprofilefieldforcelistvalues'] = 'Valeurs de profil pour forcer le mode liste';
...
$string['localmycategorypathstopcats'] = 'Catégories racines';
...
$string['myfavoritecourses'] = 'Mes favoris';
$string['mymanagedcourses'] = 'Les cours que je coordonne';
$string['myremotecourses'] = 'Les cours que je suis ailleurs';
...
$string['nocontent'] = 'Vous n\'avez aucun contenu ou service accessible sur ce site.';
...
$string['tocompleteusers'] = 'Reste à achever (étudiants)';
$string['trimchars'] = "Caractères";
$string['trimwords'] = "Mots";
$string['todisplayauto'] = 'Changer pour le mode automatique';
$string['todisplaycards'] = 'Changer pour l\'affichage en cartes';
$string['todisplaylist'] = 'Changer pour l\'affichage en liste';
$string['todisplaysummary'] = 'Changer pour l\'affichage des résumés';
...
$string['uncompleteassignusers'] = 'Etudiants avec des devoirs à remettre';
