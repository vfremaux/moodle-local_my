...
final class pro_manager {
    ...
    public static $shortcomponent = 'local_my';
    public static $component = 'local_my';
    public static $componentpath = 'local/my';
    public static $componentsettings = 'localsettingmy';
     ...
     * When used with embty feature, juste tests this is a pro equiped package.
    ...
    public function require_pro($feature = false) {
        ...
        if (!empty($feature)) {
            if ($func($feature)) {
                if (!self::set_and_check_license_key()) {
    ...
    public function set_and_check_license_key($customerkey = null, $provider = null, $interactive = false) {
        ...
        // cache result for keeping the repsonse valid for a while.
