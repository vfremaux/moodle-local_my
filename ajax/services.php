...
/**
 * Ajax services for Local my.
 */
require('../../../../config.php'); // May require level adjust.
require_once($CFG->dirroot.'/local/my/pro/prolib.php');
...
if ($action == 'license') {
    ...
    $manager = new \local_courseindex\pro_manager();

    $result = $manager->set_and_check_license_key($customerkey, $provider);
    echo $result;
    die;
}