...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var localmypro = {
        ...
        component: 'local_my',
        shortcomponent: 'local_my',
        componentpath: 'local/my',

        init: function() {

            var licensekeyid = '#id_s_' + localmypro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + localmypro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            if (crc === calculated) {
                ...
                url += '&provider=' + $('#id_s_' + localmypro.component + '_licenseprovider').val();
