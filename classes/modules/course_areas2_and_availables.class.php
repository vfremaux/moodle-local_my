...
require_once($CFG->dirroot.'/local/my/classes/modules/course_areas2.class.php');
require_once($CFG->dirroot.'/local/my/classes/modules/available_courses.class.php');

class course_areas2_and_availables_module extends course_areas2_module {
    ...
    public function __construct() {
        parent::__construct();
        $this->area = 'course_areas2_and_availables';
    ...
    public function get_courses() {
        ...
        if (empty($this->retainedcategories)) {
            return;
        }
