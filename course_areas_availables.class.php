...
class course_areas_availables_module extends course_areas_module {
    ...
    public function __construct() {
        parent::__construct();
        $this->area = 'course_areas_availables';
        $this->modulename = get_string('courseareasavailables', 'local_my');
